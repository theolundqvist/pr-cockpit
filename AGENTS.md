...
- PR detail headers and tabs use the standard width; Conversation keeps an 816px primary column with its sidebar adjacent, and Files alone expands to full width.
